...
criterion is null in every regime tested, including the high-rank
Fourier PINN itself: \emph{superposition is necessary but not
sufficient}. Practically, conventional signals (losses, residuals,
...
identical null at smaller scale. \textbf{Superposition is necessary
but not sufficient}: crossing into the high-rank regime transfers the
SAE's compression advantage but not effect-magnitude causal
specificity. The chain now reads: rank $\to$ reconstruction advantage
(measured, both regimes), reconstruction advantage $\to$ causal
specificity (absent, every regime tested: stages 5/8, H16b, R2b).

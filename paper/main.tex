...
\paragraph{Scope.} One task (1D Poisson), one embedding family, one
width; PR $> 3$ is this protocol's preregistered operational bar, not a
universal constant. A frequency sweep ($n_{\mathrm{freq}} \in
\{2,\dots,64\}$), a second PDE, and the causal battery on the Fourier
dictionaries (does the reconstruction advantage extend to
\emph{effect-magnitude specificity}?) are preregistered as R2/R3/R5
(\S\ref{sec:reconciliation}).
